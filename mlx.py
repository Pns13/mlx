...
def passwrd():
	...
	print('')
	print(f'{sir} Hasil {h}OK{x} Tersimpan Di : {h}OK/%s {x}'%(okc))
	print(f'{sir} Hasil {k}CP{x} Tersimpan Di : {k}CP/%s {x}'%(cpc))
	print(f'{sir} Mainkan Mode Pesawat Setiap {m}1k{x} Idz\n')
